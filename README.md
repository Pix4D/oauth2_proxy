...
1. Download [Prebuilt Binary](https://github.com/Pix4D/oauth2_proxy/releases) (current release is `v2.3.1`) or build with `$ go get github.com/Pix4D/oauth2_proxy` which will put the binary in `$GOROOT/bin`
